...
const ForgotPasswordComponent = () => {
  ...
  const {succesForgotPassword, errorForgotPassword, errorFieldPassword, loadingForgotPassword} = useSelector((state) => state.forgotPasswordState)
          ...
          <div className="bg-white py-12 px-8 shadow-lg sm:rounded-2xl border border-gray-100">
            <div className="text-center">
              ...
              <button
                ...
                className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 transition-colors duration-200"
              >
        ...
        <div className="bg-white py-6 px-8 shadow-lg sm:rounded-2xl border border-gray-100">
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className={`w-full pl-10 pr-4 py-3.5 border rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200 ${
                    ( error || errorFieldPassword?.email) ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white hover:border-gray-400'
                  }`}
              ...
              {(error || errorFieldPassword?.email) && (
            ...
            <button
              ...
              className="w-full flex justify-center items-center px-4 py-3.5 border border-transparent rounded-lg text-base font-semibold text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
            >
