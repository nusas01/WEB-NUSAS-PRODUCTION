...
const TransactionDashboard = () => {
    ...
    const [paidTransactions] = useState([
        {
        id: "txn_paid_001",
        tenant_id: "tenant_001",
        store_tenant_id: "store_001",
        amount: 150000,
        status: "PAID",
        channel_code: "OVO",
        xendit_transaction_id: "xendit_paid_123456",
        created_at: "2025-08-19T08:30:00Z"
        },
        {
        id: "txn_paid_002",
        tenant_id: "tenant_002",
        store_tenant_id: "store_003",
        amount: 75000,
        status: "PAID",
        channel_code: "DANA",
        xendit_transaction_id: "xendit_paid_789012",
        created_at: "2025-08-19T10:15:00Z"
        },
        {
        id: "txn_paid_003",
        tenant_id: "tenant_003",
        store_tenant_id: "store_006",
        amount: 300000,
        status: "PAID",
        channel_code: "BCA",
        xendit_transaction_id: "xendit_paid_345678",
    ...
    const [pendingTransactions] = useState([
        ...
        store_tenant_id: "store_007",
        amount: 200000,
        tax: 20000,
        fee_transaction: 5000,
        status: "PENDING",
        channel_code: "GOPAY",
        product: "Premium Subscription",
        xendit_transaction_id: "xendit_pending_111",
        created_at: "2025-08-19T12:00:00Z"
        },
        {
        id: "txn_pending_002",
        tenant_id: "tenant_005",
        store_tenant_id: "store_008",
        amount: 100000,
        tax: 10000,
        fee_transaction: 3000,
        status: "PENDING",
        channel_code: "SHOPEEPAY",
        product: "Basic Plan",
        xendit_transaction_id: "xendit_pending_222",
        created_at: "2025-08-19T11:30:00Z"
        },
        {
        id: "txn_pending_003",
        tenant_id: "tenant_006",
        store_tenant_id: "store_009",
        amount: 500000,
        tax: 50000,
        fee_transaction: 15000,
        status: "PENDING",
        channel_code: "BNI",
        product: "Enterprise Package",
        xendit_transaction_id: "xendit_pending_333",
    ...
    const handleCheckPayment = (transaction) => {
        alert(`Checking payment status for transaction ${transaction.id}\nXendit ID: ${transaction.xendit_transaction_id}\nAmount: ${formatCurrency(transaction.amount)}\n\nThis will query the payment gateway for current status.`);
    };
                                ...
                                {filteredPendingTransactions.map((transaction, index) => (
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        <button 
                                            ...
                                            className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg"
                                        >
