...
const StoreDeploymentDashboard = () => {
    ...
    useEffect(() => {
        if (accountCustomerStoreTestingError) {
            setToast({
                type: "error",
                message: "terjadi kesalahan membuat account testing customer store, silahkan coba lagi nanti."
            })
        }
                                    ...
                                    <tr key={store.id} className="hover:bg-gray-50">
                                        ...
                                        <div className="flex items-center justify-end space-x-2">
                                            ...
                                            >
                                                ...
                                                { loadingDeployApp ? 'Deploying...' : 'Deploy'}
                                            </button>
                                            )}
                                            ...
                                            {isCredentialsFilled(store.tenant) && (
                                            <button
                                                disabled={loadingDeployFinished}
                                            ...
                                            >
                                                ...
                                                { loadingDeployFinished ? 'Finishing...' : 'Finished'}
                                            </button>
                                            )}
                                        </div>
                                        </td>
